...
#define CMD_CONV_CHECK        15
#define CMD_LIFT_RAMP_READY   16

// STATUS BUS INDICES (Robot -> PC)
#define STAT_HW_ID            0
#define STAT_POS_ALPHA        1
#define STAT_POS_BETA         2
#define STAT_GRIPPER_DETECT   3
#define STAT_PROX_SENSOR      4
#define STAT_TASK_COMPLETE    5
#define STAT_LIMIT_MIN_HIT    6
#define STAT_LIMIT_MAX_HIT    7
#define STAT_ESTOP_HIT        8
#define STAT_RAMP_CONTACT     9
#define STAT_BRICK_PRESENT   10
#define STAT_IR_SIGNAL       11
